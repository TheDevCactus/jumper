use bevy::{
    app::{App, Plugin, Update}, core_pipeline::core_2d::Camera2dBundle, ecs::{
        schedule::{common_conditions::in_state, IntoSystemConfigs, NextState, OnEnter, OnExit},
        system::{Commands, Res, ResMut},
    }, input::{keyboard::KeyCode, Input}, utils::default
};
...
fn update_home(mut commands: Commands, keyboard_input: Res<Input<KeyCode>>, mut scene_state: ResMut<NextState<Scene>>) {
    ...
    if keyboard_input.just_pressed(KeyCode::Key3) {
        ...
        commands.insert_resource( LevelID("plains_3".to_string()));
        should_nav = true;
    }
